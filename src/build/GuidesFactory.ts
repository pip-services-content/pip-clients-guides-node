...
export class GuidesFactory extends Factory {
	...
	constructor() {
		...
		this.registerAsType(GuidesFactory.DirectClientV1Descriptor, GuidesDirectClientV1);
		this.registerAsType(GuidesFactory.HttpClientV1Descriptor, GuidesHttpClientV1);
		this.registerAsType(GuidesFactory.SenecaClientV1Descriptor, GuidesSenecaClientV1);
	}
